...
<section class="speakers">
    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente): ?>
            <div data-aos-offset="-500" data-aos="zoom-in-up" class="speaker">
                <picture>
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if(!empty($redes->whatsapp)): ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->whatsapp; ?>">
                                <span class="speaker-sociales__ocultar">Whatsapp</span>
                            </a>
                        <?php endif; ?> 
                    </nav>
